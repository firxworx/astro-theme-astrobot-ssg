import { ASTRO_SITE_URL, SITE } from '@config'
import { TemplateLogoSvg } from './TemplateLogoSvg'

const HOSTNAME = new URL(ASTRO_SITE_URL).hostname

/**
 * Image template for generating social media images (OpenGraph + Twitter/X) for the site.
 *
 * @see https://og-playground.vercel.app/ online tool to help design og templates
 */
export const SiteImageTemplate = (): JSX.Element => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ overflow: 'hidden', fontWeight: 'bold' }}>{HOSTNAME}</span>
            <TemplateLogoSvg
              style={{
                color: textColor,
